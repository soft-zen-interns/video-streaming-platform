							...
							<h2 id="content">
								...
								<div className="buttons">
									<div className="buttonSection">
										<button id="googleFbBtn"><img src={GoogleLogo} alt="google.png" className = "image" id="googleImg"/><span className="btnText">CONNECTED</span></button>
									</div>
									<div className="buttonSection">
										<button id="googleFbBtn"><img src={FBLogo} alt="facebook.png" className = "image" id="googleImg"/><span className="btnText">CONNECTED</span></button>
									</div>
								</div>
